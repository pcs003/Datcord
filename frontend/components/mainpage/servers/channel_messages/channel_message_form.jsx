...
export default class ChannelMessageForm extends React.Component {
    ...
    render() {
        let placeholder = `Message #${this.props.currentChannel.name}`
        return (
            <div className="message-input-div">
                <svg onClick={this.unfinished} className="add-file" width="24" height="24" viewBox="0 0 24 24">
                ...
                <input
                    ...
                    autoComplete="off"
                />
                <svg onClick={this.unfinished} className="" width="24" height="24" viewBox="0 0 24 24">
                ...
                <img onClick={this.unfinished} src={window.grayDatcordRobot} alt=""/>
                <Popup />
            </div>
        );
    }
