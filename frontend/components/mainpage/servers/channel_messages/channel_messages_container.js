...
import { createChannelMessage, deleteChannelMessage, fetchChannelMessages, receiveChannelMessage, updateChannelMessage } from '../../../../actions/channel_message_actions';
...
const mapDispatchToProps = dispatch => ({
    ...
    createChannelMessage: channelMessage => dispatch(createChannelMessage(channelMessage)),
