...
export default class FriendsInfoNavbar extends Component {
    render() {
        ...
        return (
            <div className="info-navbar">
                <div className="info-items">
                    ...
                    <div className={infoItemClass[0]} onClick={this.props.unfinished}>
                        Online
                    </div>
                    <div className={infoItemClass[1]} onClick={this.props.clickTab(1)}>
                        All
                    </div>
                    <div className={infoItemClass[2]} onClick={this.props.clickTab(2)}>
                        Pending
                    </div>
                    <div className={infoItemClass[3]} onClick={this.props.unfinished}>
                        Blocked
                    </div>
                    <div className={infoItemClass[4]} onClick={this.props.clickTab(4)}>
                        Add Friend
                    </div>

                </div>
                <div className="other-options">
                    <svg onClick={this.props.unfinished} width="24" height="24" viewBox="0 0 24 24">
